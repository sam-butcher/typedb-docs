...
[NOTE]
====
If you're using TypeDB Community Edition >=3.2.0-rc1, you can access the new TypeDB Studio experience at https://studio.typedb.com! Desktop builds will be published soon.

Otherwise, see the below installation instructions for the legacy versions of TypeDB Studio.
====
