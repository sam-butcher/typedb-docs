...
See the https://github.com/typedb/typedb-studio/releases/tag/3.4.0-rc1[GitHub release notes] or download the TypeDB Studio desktop application from https://cloudsmith.io/~typedb/repos/public-release/packages/?q=name:%5Etypedb-studio[Cloudsmith].
====
