= `@abstract` annotation
:page-aliases: {page-version}@new_reference::typeql/pages/statements/abstract.adoc
...
[,typeql]
----
include::{page-version}@new_reference::example$tql/schema_annotations.tql[tags=define-keyword;abstract-entity;]
----
...
[,typeql]
----
include::{page-version}@new_reference::example$tql/schema_annotations.tql[tags=define-keyword;abstract-attribute]
----
...
[,typeql]
----
include::{page-version}@new_reference::example$tql/schema_annotations.tql[tags=define-keyword;abstract-relation]
----
