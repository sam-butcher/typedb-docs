= `@regex` annotation
:page-aliases: {page-version}@new_reference::typeql/pages/statements/regex.adoc
...
include::{page-version}@new_reference::typeql/pages/annotations/values.adoc[tags=values-and-owns-annotations-description-values]

[,typeql]
----
include::{page-version}@new_reference::example$tql/schema_annotations.tql[tags=define-keyword;regex-value]
----

[#_example_owns]
include::{page-version}@new_reference::typeql/pages/annotations/values.adoc[tags=values-and-owns-annotations-description-owns]
...
[,typeql]
----
include::{page-version}@new_reference::example$tql/schema_annotations.tql[tags=define-keyword;phone-attribute;regex-owns]
----

=== Subtyping

The `regex` constraint put on an attribute types' value type is inherited.
include::{page-version}@new_reference::typeql/pages/annotations/values.adoc[tags=value-constraints-subtyping]
...
Is only compatible with xref:{page-version}@new_reference::typeql/pages/values/string.adoc[`string` value type].
