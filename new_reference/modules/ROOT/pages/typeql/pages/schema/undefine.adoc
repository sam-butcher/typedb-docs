= Undefine query
:page-aliases: {page-version}@new_reference::typeql/pages/queries/undefine.adoc
...
* xref:{page-version}@new_reference::typeql/pages/statements/relates.adoc[`relates ... from` statements] undefine existing relates and role types.
* xref:{page-version}@new_reference::typeql/pages/statements/relates.adoc[`as ... from relates` statements] undefine existing relates specializations.
* xref:{page-version}@new_reference::typeql/pages/statements/plays.adoc[`plays ... from` statements] undefine existing roleplayings.
* xref:{page-version}@new_reference::typeql/pages/statements/owns.adoc[`owns ... from` statements] undefine existing ownerships.
* xref:{page-version}@new_reference::typeql/pages/statements/value.adoc[`value ... from` statements] undefine existing attribute types' value types.
* xref:{page-version}@new_reference::typeql/pages/statements/sub.adoc[`sub ... from` statements] undefine existing subtyping connections.
* xref:{page-version}@new_reference::typeql/pages/annotations/index.adoc[`@annotation ... from` statements] undefine existing annotations.
...
* xref:{page-version}@new_reference::typeql/pages/statements/fun.adoc[`fun ...` statements] undefine existing functions.
...
include::{page-version}@new_reference::typeql/pages/functions/writing.adoc[tag=undefine]
