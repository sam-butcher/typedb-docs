= `let ... =` statement
:page-aliases: {page-version}@new_reference::typeql/pages/statements/value-assignment.adoc, {page-version}@new_reference::typeql/pages/values/value-variables.adoc
