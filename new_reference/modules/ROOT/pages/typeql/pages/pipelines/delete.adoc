= Delete stage
:page-aliases: {page-version}@new_reference::typeql/pages/queries/delete.adoc
...
* xref:{page-version}@new_reference::typeql/pages/statements/has.adoc[Delete has statements] delete ownerships of attributes.
* xref:{page-version}@new_reference::typeql/pages/statements/links.adoc[Delete links statements] delete role players from relations.
