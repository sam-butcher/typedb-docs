...
A put stage will xref:{page-version}@new_reference::typeql/pages/pipelines/insert.adoc[insert] data according to a pattern if no existing data xref:{page-version}@new_reference::typeql/pages/pipelines/match.adoc[matches] that pattern.

== Syntax

As a put stage may insert data, the body of a put stage is a sequence of valid xref:{page-version}@new_reference::typeql/pages/pipelines/insert.adoc[insert] statements.
